...
class TokenTools{
    public:
        static std::string token_type_to_string(TokenType type){
            ...
            ,"TRUE_T","FALSE_T","ALPHA_T","NUM_T","QUOTE_T","PROGRAM_NT","PROGRAM_HEADER_NT","PROGRAM_BODY_NT","IDENTIFIER_NT","DECLARATION_NT","STATEMENT_NT",
            ...
            "DESTINATION_NT","EXPRESSION_NT","ARITH_OP_NT","RELATION_NT","TERM_NT","FACTOR_NT","NAME_NT","STRING_NT","DECLARATION_ARRAY_NT","STATEMENT_ARRAY_NT","END_OF_FILE","NONE" };
