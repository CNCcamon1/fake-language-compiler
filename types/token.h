...
enum TokenType{
    ...
    NAME_NT = 70,
    STRING_NT = 71,
    DECLARATION_ARRAY_NT = 72,
    STATEMENT_ARRAY_NT = 73,
...
class TokenTools{
    public:
        static std::string token_type_to_string(TokenType type){
            ...
            "EXPRESSION_RECURSE_NT","STRING_LITERAL_NT", "ARITH_OP_RECURSE_NT", "RELATION_RECURSE_NT", "TERM_RECURSE_NT","END_OF_FILE","NONE" };
