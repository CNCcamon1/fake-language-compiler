...
class Grammar{
    ...
    private:
        std::vector<std::vector<std::vector<GrammarOption*>>> grammarOptionsTable {
            ...
            {{new GrammarOption(DECLARATION_OBJ_NT, ARRAY__C), new GrammarOption(BEGIN_T), new GrammarOption(STATEMENT_OBJ_NT, ARRAY_C), new GrammarOption(END_T), new GrammarOption(PROCEDURE_T)}}, //PROCEDURE_BODY_NT
            ...
            {{new GrammarOption(NOT_T, OPTIONAL_C), new GrammarOption(ARITH_OP_NT), new GrammarOption(EXPRESSION_RECURSE_NT, OPTIONAL_C)}}, //EXPRESSION_NT
            ...
            {{new GrammarOption(AND_T), new GrammarOption(ARITH_OP_NT)}, {new GrammarOption(OR_T), new GrammarOption(ARITH_OP_NT)}}, //EXPRESSION_RECURSE_NT
            {{}}, //STRING_LITERAL_NT
            ...
            {{new GrammarOption(ELSE_T), new GrammarOption(STATEMENT_BLOCK_NT, ARRAY_C)}}, //ELSE_BLOCK_NT
